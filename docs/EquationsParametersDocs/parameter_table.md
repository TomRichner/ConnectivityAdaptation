...
| **Activation Function** |||||
| $\phi$ | Piecewise sigmoid | $(-\infty,\infty) \to [0,1]$ | — | Hard sigmoid with rounded corners |
| $a_\phi$ | Linear fraction | 0.9 | — | Fraction of domain with slope 1 |
| $c_\phi$ | Sigmoid center | 0.4 | — | Horizontal shift; $\phi(c_\phi) = \frac{1}{2}$ |
